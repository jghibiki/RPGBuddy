...
module.exports = function(opts, modules){
    ...
    function bindListeners(opts, socket){;
        ...
        function addUser(req){
            ...
            var userPath = path.join(userManager.userDataLoc, username);
            ...
            userManager.users.push(baseManifest);
            socket.emit("user:add::response", baseManifest);
        ...
        function updateUser(updatedUser){
            for(var i=0; i < userManager.users; i++){
                if(userManager.users[i].username === updatedUser.username){
                    ...
                    var userPath = path.join(userManager.userDataLoc, updatedUser.username);
